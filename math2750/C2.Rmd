...
*This assessment counts as 4% of your final module grade. You should write a report on your work (see Question 0 below), answering the questions and showing any relevant R code. The deadline for submission is **Thursday 26 March at 2pm**. Your report should be handed in **electronically, via Minerva**. Best formats are PDF or HTML; a Word document is fine; plain text files (eg .Rmd) are discouraged. Your work must clearly show your name and your student number. Late submissions up to Thursday 2 April at 2pm will still be marked, but the total mark will be reduced by 50%. You must email your marker to submit late work. Work submitted after Thursday 2 April at 2pm will not be marked.*
...
* *[`C2.Rmd`](https://mpaldridge.github.io/math2750/C2.Rmd) is a plain text file. I recommend opening this file in RStudio. This will make it easy to run the R code included here, by clicking the green "play" button by each chunk of R code. (This file is written in a language called ["R Markdown"](https://www.stat.cmu.edu/~cshalizi/rmarkdown/).)*

*This question sheet assumes you can open RStudio (or operate R in whatever way you prefer), and that you can use basic commands such as `x <- c(1, 2, 3)` and `mean(x)`. The University of Leeds* [Introduction to R](http://www1.maths.leeds.ac.uk/statistics/R/Rintro.pdf) *covers more basic topics. If you have access to a computer but you can't install R on it, I recommend the [RStudio Cloud](https://rstudio.cloud/) online.*
