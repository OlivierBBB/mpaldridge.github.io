...
You can download the [R Markdown source code for this report here](https://mpaldridge.github.io/math2750/C1-example.Rmd). If you open that file in RStudio and click on `knit`, it should produce [the HTML version of the report](https://mpaldridge.github.io/math2750/C1-example.html) --  although it probably won't work on a University computer. Note also that the R code (including generation of random numbers) is run anew, so your graphs and sample estimates will not be exactly the same as mine.